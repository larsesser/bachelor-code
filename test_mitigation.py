...
class TestResult(NamedTuple):
    """The result of one call of the error_correction procedure.

    This contains the expectation values for <psi|O|psi>, where O is a given operator
    and |psi> is a random state generated by the test_projective_measurement procedure.
    """
    noiseless: float
    noisy: float
    corrected: float
...
def test_projective_measurement(
    ...
    return TestResult(noisy=noisy_result, noiseless=noiseless_result, corrected=float(corrected))
